...
Systemdrawer::Systemdrawer(std::string a_name)
{
    init();
}

void Systemdrawer::draw(mat4f &mvp){
...
void Systemdrawer::init(){
    ...
    programID = LoadShadersVertFrag("System.vertexshader", "System.fragmentshader");
    matrixID = glGetUniformLocation(programID, "MVP");
    texturesamplerID = glGetUniformLocation(programID, "myTextureSampler");
}

void Systemdrawer::load(){
    mesh.vertices.push_back(Vec3f(-0.5,-0.5, -0.5));
    mesh.vertices.push_back(Vec3f( 0.5,-0.5, -0.5));
    mesh.vertices.push_back(Vec3f( 0.5, 0.5, -0.5));
    mesh.vertices.push_back(Vec3f(-0.5,-0.5, -0.5));
    mesh.vertices.push_back(Vec3f( 0.5, 0.5, -0.5));
    ...
    textureLocationID = loadPNG("Oxygengenerator.png");
