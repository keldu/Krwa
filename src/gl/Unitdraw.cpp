...
Unitdraw::Unitdraw(std::string a_name): name(a_name){
    init();
}
...
void Unitdraw::init(){
    ...
    programID = LoadShadersVertFrag("Unit.vertexshader", "Unit.fragmentshader");
...
void Unitdraw::load(){
    ...
    mesh.vertices.push_back(Vec3f(-0.4,-0.4, -0.5));
    mesh.vertices.push_back(Vec3f( 0.4,-0.4, -0.5));
    mesh.vertices.push_back(Vec3f( 0.4, 0.4, -0.5));
    mesh.vertices.push_back(Vec3f(-0.4,-0.4, -0.5));
    mesh.vertices.push_back(Vec3f( 0.4, 0.4, -0.5));
